...
export function NoticeSampleExcelPage() {
  ...
  const canValidate = Boolean(page.excelFile);
  const canSave = Boolean(page.validation?.isValid && page.excelFile);
  const canTestPdf = page.isValidated;
    ...
    <div className="mx-auto max-w-4xl space-y-6 pb-10">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              type="button"
              variant="outline"
              disabled={!canValidate || page.validating}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            type="button"
            disabled={!canTestPdf || page.testPdfLoading}
